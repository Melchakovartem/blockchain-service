...
RSpec.describe "Wallet create" do
  context "Root invite" do
    ...
    context "with valid id" do
      it "returns status :created" do
        post create_wallet_v1_owners_path, params: { profile_id: profile_id, profile_params: { root: true } }
  ...
  context "Non root invite" do
    ...
    context "with valid id" do
      it "returns status :created" do
        post create_wallet_v1_owners_path, params: { profile_id: referral_profile_id, profile_params: { root: false, referrer_profile_id: referrer_profile_id } }
        expect(response).to have_http_status(:created)
      end 
