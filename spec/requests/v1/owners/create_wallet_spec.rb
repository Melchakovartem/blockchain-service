...
RSpec.describe "Wallet create" do
  context "Root invite" do
    ...
    context "with valid id" do
      it "returns status :created" do
        post v1_owner_create_wallet_path(profile_id), params: { profile_params: { root: true } }
  ...
  context "Non root invite" do
    ...
    context "with valid id" do
      it "returns status :created" do
        post v1_owner_create_wallet_path(referral_profile_id), params: { profile_params: { root: false, referrer_profile_id: referrer_profile_id } }
        expect(response).to have_http_status(:created)
      end 
